...
namespace MemoryOnline.Common.IOC
{
    public static class EFServiceCollectionExtensions
    {
        ...
        /// </summary>
        public static IServiceCollection AddGameRepositoryEF(this IServiceCollection services)
        {
        ...
        public static IServiceCollection AddUsersRepositoryEF(this IServiceCollection services)
        {
